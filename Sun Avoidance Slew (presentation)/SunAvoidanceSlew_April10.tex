...
\end{enumerate}
 ...
 \end{equation}
\begin{figure}
\includegraphics[width=2.4in]{./Figures/SVAS_1r_modified}\includegraphics[width=2.3in]{./Figures/SVAS_1rb_modified}
\end{figure}
\end{block}
\end{frame}
...
\end{equation}
\begin{figure}
\includegraphics[width=2.3in]{./Figures/SVAS_2r_modified}
\end{figure}
\end{block}
\end{frame}
%-------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
\end{enumerate}
\begin{figure}
\includegraphics[width=2.3in]{./Figures/SVAS_3r_modified}
\end{figure}
\end{block}
\end{frame}
