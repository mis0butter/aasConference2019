...
% \phi_1=\left\{
%                \begin{array}{ll}
%                 \cos^{-1}(\hat{P}_i\cdot_G\hat{S}_{||})-\epsilon_p& {\scriptstyle when}\  \cos^{-1}(\hat{P}_i\cdot_G\hat{S}_{||})-\epsilon_p\leq \pi\\
%                 \cos^{-1}(\hat{P}_i\cdot_G\hat{S}_{||})-\epsilon_p-2\pi& {\scriptstyle when}\ \cos^{-1}(\hat{P}_i\cdot_G\hat{S}_{||})-\epsilon_p>\pi\\
%                \end{array}
%              \right.
% \end{equation}
 %\begin{figure}
 %\includegraphics[width=1.75in]{./Figures/SVAS_1r_modified}\includegraphics[width=2in]{./Figures/SVAS_1rb_modified}
 %\end{figure}
\begin{columns}
...
%\begin{figure}
%\includegraphics[width=2in]{./Figures/SVAS_2r_modified}\includegraphics[width=1.5in]{./Figures/SASSchematic4}
%\end{figure}
...
% \phi_3=\left\{
%                \begin{array}{ll}
%                  \cos^{-1}(_G\hat{P}_f.\hat{P}_2)& {\scriptstyle when} \  _G\hat{P}_f.\hat{P}_2\geq 0\\
%                 \cos^{-1}(_G\hat{P}_f.\hat{P}_2)-2\pi& {\scriptstyle when} \ _G\hat{P}_f.\hat{P}_2<0\\
%                \end{array}
%              \right.
% \end{equation}
\begin{figure}
...
% \phi_1=\left\{
%                \begin{array}{ll}
%                 \cos^{-1}(\hat{P}_i\cdot_\mathcal{G}\hat{S}_{||})-\epsilon_p& {\scriptstyle when} \  \cos^{-1}(\hat{P}_i\cdot_\mathcal{G}\hat{S}_{||})-\epsilon_p\leq \pi\\
%                 \cos^{-1}(\hat{P}_i\cdot_\mathcal{G}\hat{S}_{||})-\epsilon_p-2\pi& {\scriptstyle when} \ \cos^{-1}(\hat{P}_i\cdot_\mathcal{G}\hat{S}_{||})-\epsilon_p>\pi\\
%                \end{array}
%              \right.
% \end{equation}
...
% \phi_3=\left\{
%                \begin{array}{ll}
%                  \cos^{-1}(_\mathcal{G}\hat{P}_f.\hat{P}_2)& {\scriptstyle when} \  _\mathcal{G}\hat{P}_f.\hat{P}_2\geq 0\\
%                 \cos^{-1}(_\mathcal{G}\hat{P}_f.\hat{P}_2)-2\pi& {\scriptstyle when} \ _\mathcal{G}\hat{P}_f.\hat{P}_2<0\\
%                \end{array}
%              \right.
% \end{equation}
...
\end{itemize}
 ...
 \ddot{\phi}(t)=u=\left\{
                \begin{array}{ll}
                \ddot{\phi}_{max}& {\scriptstyle when} \  t_0\leq t\leq t_1,\\
                 0& {\scriptstyle when} \  t_1\leq t \leq t_2,\\
                 -\ddot{\phi}_{max}& {\scriptstyle when}  \ t_2\leq t\leq t_f.
                \end{array}
              \right.
\begin{minipage}{0.35\textwidth}
\begin{center}
...
\end{itemize}
 ...
 \dot{\phi}(t)=\left\{
                \begin{array}{ll}
                \dot{\phi}_0+\ddot{\phi}_{max}(t-t_0)& {\scriptstyle when} \  t_0\leq t\leq t_1,\\
                 \dot{\phi}_{max}& {\scriptstyle when} \  t_1\leq t \leq t_2,\\
                 \dot{\phi}_{max}-\ddot{\phi}_{max}(t-t_2)& {\scriptstyle when} \ t_2\leq t\leq t_f.
                \end{array}
              \right.
 \end{equation}
  \begin{itemize}
...
%		\begin{figure}
%			\centering
%			\subfloat[caption 1]{{\includegraphics[width=1.5in]{figures/alphaNot0/ang_vel_phi_total.png} }}
%			\qquad
%			\subfloat[label 2]{{\includegraphics[width=1.5in]{figures/alphaNot0/ang_accel_total.png} }}
...
% THIS IS THE SLIDE THAT DOESN'T COMPILE GOOD
%\begin{frame}{Computing Steering Profiles}
%
%\begin{block}{ }
%	\begin{enumerate}
